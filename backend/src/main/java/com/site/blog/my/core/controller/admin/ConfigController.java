...
public class ConfigController {
    ...
    //@ResponseBody
    //public com.site.blog.my.core.util.Result website(@RequestParam(value = "websiteName", required = false) String websiteName,
    ...
    //@ResponseBody
    //public com.site.blog.my.core.util.Result userInfo(@RequestParam(value = "yourAvatar", required = false) String yourAvatar,
    ...
    //@ResponseBody
    //public com.site.blog.my.core.util.Result footer(@RequestParam(value = "footerAbout", required = false) String footerAbout,
