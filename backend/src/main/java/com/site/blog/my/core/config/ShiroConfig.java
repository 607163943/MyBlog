...
import com.site.blog.my.core.filter.LoginFilter;
import com.site.blog.my.core.security.LoginRealm;
...
public class ShiroConfig {
    ...
    public DefaultShiroFilterChainDefinition defaultShiroFilterChainDefinition() {
        ...
        // 配置过滤器拦截规则
        // 只拦截管理端请求，不拦截前台请求
        defaultShiroFilterChainDefinition.addPathDefinition("/admin/**", LoginFilter.Filter_NAME);
