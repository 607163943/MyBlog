...
public class ArticleController {
    ...
    //@ResponseBody
    //public com.site.blog.my.core.util.Result save(@RequestParam("blogTitle") String blogTitle,
    ...
    //@ResponseBody
    //public com.site.blog.my.core.util.Result update(@RequestParam("blogId") Long blogId,
    ...
    //@ResponseBody
    //public com.site.blog.my.core.util.Result delete(@RequestBody Integer[] ids) {
    //    if (ids.length < 1) {
