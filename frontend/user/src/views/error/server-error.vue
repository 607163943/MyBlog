...
<template>
  <div class="cover">
    ...
    <p class="lead">
      An unexpected condition was encountered.<br />Our service team has been dispatched to bring it
      back online.
    </p>
    <p>
      报告问题
      <a href="https://github.com/ZHENFENG13/My-Blog/issues/new" target="_blank">New Issues</a>
    </p>
  </div>
</template>
